...
public abstract class FileDao<T> {
     ...
     */
    public List<T> readObject(Function<String[], T> mapper) throws StorageException {
     ...
     */
    public void writeObject(Collection<T> items, Function<T, String> mapper) throws StorageException {
     ...
     */
    public void appendObject(T item, Function<T, String> mapper) throws StorageException {
